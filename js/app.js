(() => {
  ...
  window.addEventListener("load", function (e) {
    !(function () {
      if (
        (me(),
        document.querySelector(".screens__slider") &&
          new de(".screens__slider", {
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            spaceBetween: 30,
        ...
        document.querySelector(".customers__slider"))
      ) {
        let e = new de(".thumb-slider-customers", {
            modules: [pe, fe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
          ...
          t = new de(".content-slider-customers", {
            modules: [fe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
      ...
      document.querySelector(".plan__slider") &&
        new de(".plan__slider", {
          modules: [he],
          observer: !0,
          observeParents: !0,
          ...
          grabCursor: !0,
          speed: 800,
          pagination: { el: ".slider-plan__pagging", clickable: !0 },
          on: {},
        });
    })();
  });
